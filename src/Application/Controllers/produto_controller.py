...
class ProductController:
    def __init__(self):
        ...
        self.blueprint = Blueprint('product', __name__, url_prefix='/api/products')
        self._register_routes()

    def _register_routes(self):
        # ✅ CORRETO: Rotas separadas para evitar conflitos
        self.blueprint.add_url_rule('', 'list_products', self.list_products, methods=['GET'])
        self.blueprint.add_url_rule('', 'create_product', self.create_product, methods=['POST'])
        self.blueprint.add_url_rule('/<int:product_id>', 'get_product', self.get_product_details, methods=['GET'])
